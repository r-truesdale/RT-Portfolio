...
function Projects() {
  const [activeKey, setActiveKey] = useState('greenDigital');
  ...
  const projects = [
    {
      key: 'greenDigital',
      title: (
        <div className={styles.projCard1} style={{ cursor: 'pointer' }} as>
          <h2 className={styles.projName}>QM HabitApp</h2>
          <img src={gTwinImg} alt="Digital Twin Thumbnail" className={styles.projThumbnail} />
          <p className={styles.projDesc}><span className={themes.bold}>Encouraging local environmental interest through an interactive user experience.</span></p>
         <p className={styles.projDesc}>A physical map was linked with an online app through an NFC card and Arduino components.</p>
        </div>
      ),
      content: (
        ...
        <div className={themes.sectionCard}>
          <div className={styles.project}>
            <div className={styles.projIntro}>
              <h1 className={styles.projTitle} >QM HabitApp</h1>
    ...
    },
    {
      key: 'rhythmGame',
      title: (
        <div className={styles.projCard1} style={{ cursor: 'pointer' }}>
          ...
          <p className={styles.projDesc}><span className={themes.bold}>A rhythm game created with Unity, using C#.</span></p>
           <p className={styles.projDesc}>Developed as my final year project at university, focusing on helping players improve their overall rhythm abilities.</p>
        </div>
        </div>
      ),
      content: (
    ...
    },
    {
      ...
      title: (
        <div className={styles.projCard1} style={{ cursor: 'pointer' }}>
          ...
          <p className={styles.projDesc}><span className={styles.bold}>A web app developed to support GCSE students when learning about the circuits topic in physics.</span></p>
        </div>
      ),
      content: (
       <div className={styles.proj}>
  ...
  const handleTabSelect = (key) => {
    setActiveKey(key);
    setTimeout(() => {
      if (projCardRef.current) {
        projCardRef.current.scrollIntoView({ behavior: 'smooth', block: 'start' });
      }
    }, 0);
  };
